...
#####  Package checksum describes algorithms for finding various checksums Package checksum describes algorithms for finding various checksums
...
3. [`Sha1`](./checksum/sha1.go#L18):  SHA1 validates the provided data using the SHA1 algorithm.
