...
// MeanUsingAndXor This function find arithmetic mean using "AND" and "XOR" operations
func MeanUsingAndXor(a int, b int) int {
	return ((a ^ b) >> 1) + (a & b)
}

// MeanUsingRightShift This function find arithmetic mean using right shift
